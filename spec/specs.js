describe('findReplace', function() {
  ...
  it("will replace an upper-case word called in lower-case without punctuation", function() {
    expect(findReplace(["All happy families are alike; each unhappy family is unhappy in its own way.", "all", "Some"])).to.eql("Some happy families are alike; each unhappy family is unhappy in its own way.");
  });
